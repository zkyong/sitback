...
public class XmlUtils {
     ...
     */
    public static Map<String, String> loadPropertiesFromXml(String filePath,
                                                            String currentPath) throws JDOMException,
                                                                                IOException {
    ...
    public static void input2Property(String xmlPath) throws JDOMException, IOException {
        ...
        // 匹配所有的input标签
        XPathExpression<Element> xpath = XPathFactory.instance().compile(JDOM_XPATH_INPUT,
            Filters.element());
