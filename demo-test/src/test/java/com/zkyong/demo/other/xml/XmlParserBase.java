...
public class XmlParserBase {
    ...
    private void getXmlMethodsSupper(Map<String, XmlMethods> xmlMethods,
        ...
        for (Field field : fields) {
            ...
            if (xmlMethod.setMethod != null && xmlMethod.getMethod != null
                && xmlMethod.fieldClass != null) {
    ...
    private void getMethodsSupper(Map<String, Method> methods, Class<?> clazz,
    ...
    public void invokeSetMethod(XmlMethods xmlMethods, Object obj, Object val) throws Throwable {
        if (xmlMethods == null || xmlMethods.setMethod == null || obj == null || val == null) {
            return;
        }
