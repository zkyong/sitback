 ...
 * 场景一：外围方法没有开启事务。
 * 结论：
 * 		试验结果证明，在外围方法未开启事务的情况下Propagation.REQUIRED修饰的内部方法会新开启自己的事务，
 * 		且开启的事务相互独立，互不干扰。
 * 
 * @author: zhangkaiyong
 * @date: 2018年10月12日 13:34:45
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "classpath:applicationContext.xml" })
public class TransactionTestRequired01 {
	@Autowired
